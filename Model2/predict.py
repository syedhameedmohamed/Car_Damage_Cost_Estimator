...
def main():
    ...
    model_weights = "model_0005999.pth"
    ...
    # Path to input image
    image_path = "Data/test/imgs/image_test.jpg"
    ...
    print('pred_scored ', pred_scores)
    
    # Filter predictions : picking the highest confidence boundingbox for the damage
    pred_boxes, pred_classes, pred_masks, pred_scores = filter_predictions(pred_boxes, pred_classes, pred_masks, pred_scores)

    print('filtered predictions with highest confidence score')
    print('pred_boxes ',pred_boxes)
    print('pred_classes ',pred_classes)
    print('pred_masks ',pred_masks)
    print('pred_scored ', pred_scores)
